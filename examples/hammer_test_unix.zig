...
fn nextConnection(allocator: std.mem.Allocator, io: std.Io) !*zs.Socket {
    ...
    if (http_context.connectUnix(allocator, io, ssl, "hammer_test.sock", 0, HttpSocket)) |connection_socket| {
...
pub fn main(init: std.process.Init) !void {
    ...
    listen_socket = http_context.listenUnix(allocator, init.io, ssl, "hammer_test.sock", 0, HttpSocket) catch |err| {
